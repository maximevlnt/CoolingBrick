...
class DataCollector(QThread):
    ...
    def run(self):
        try:
            # Connexion au port série de l'ESP8266
            ...
            while self.running:
                ...
                if line:
                    ...
                    if line.startswith("temp:"):
                        ...
                        pressure = random.uniform(950, 1050)  # Valeur aléatoire pour la pression

                        # Émettre les données au thread principal
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Initialiser le collecteur de données avec les paramètres de port série
        self.data_collector = DataCollector(port='/dev/ttyUSB0', baud_rate=9600)
